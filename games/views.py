...
def student(request):
    ...
    return render(request, 'games/student.html',
        {
            'media_url': settings.MEDIA_URL,
        })
...
def business(request):
    ...
    return render(request, 'games/business.html',
        {
            'media_url': settings.MEDIA_URL,
        })
...
def individual(request):
    ...
    return render(request, 'games/individual.html',
        {
            'media_url': settings.MEDIA_URL,
        })
...
def privacy_policy(request):
    ...
    return render(request, 'games/privacy_policy.html',
        {
            'media_url': settings.MEDIA_URL,
        })
...
def support(request):
    ...
    return render(request, 'games/support.html',
        {
            'media_url': settings.MEDIA_URL,
        })
...
def contact_us(request):
    ...
    return render(request, 'games/contact_us.html',
        {
            'media_url': settings.MEDIA_URL,
        })
